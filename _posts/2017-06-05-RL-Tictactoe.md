...
<div class="post-img">
	<img src="/images/rl_model.jpeg" width="40%">
</div>
...
<div class="post-img">
	<img src="/images/rl_tictactoe.png" width="65%">
</div>
...
- RL can be used to solve complex problems whose states are huge or even infinite. We can estimate their value functions through deep neural network, combinations of features, etc.
